...
#Show score
execute as @a[scores={time=0..},tag=!afk] run scoreboard players operation @s time_display = @s time
execute as @a[scores={level=0..},tag=!afk] run scoreboard players operation @s level_display = @s level