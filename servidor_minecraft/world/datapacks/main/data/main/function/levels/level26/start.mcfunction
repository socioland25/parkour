...
summon minecart 64 3 107 {Tags:["lvl26Minecart"],Invulnerable:1,Passengers:[{id:"ocelot",CatType:2,Invulnerable:1,Silent:0b,PersistenceRequired:1,Tags:["passenger"]}]}
