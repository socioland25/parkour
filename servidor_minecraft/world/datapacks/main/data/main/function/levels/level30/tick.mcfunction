...
scoreboard players add @e[type=marker,name=console,limit=1,tag=lvl30_timer] lvl30_timer 1
execute as @e[type=marker,name=console,limit=1,scores={lvl30_timer=5..}] run function main:levels/level30/close 