...
execute unless entity @a[scores={level=74}] run scoreboard players reset @e[type=minecraft:marker,name=console] lvl74_timer

execute if entity @a[scores={level=74}] run scoreboard players add @e[type=minecraft:marker,name=console] lvl74_timer 1
execute if entity @e[type=minecraft:marker,name=console,scores={lvl74_timer=60}] run summon minecraft:minecart 58 87 169 {Motion:[0.5d,0.0d,0.0d],Tags:["lvl74"]}
scoreboard players reset @e[type=minecraft:marker,name=console,scores={lvl74_timer=100..}] lvl74_timer
...
execute as @a[scores={level=74}] if items entity @s armor.chest minecraft:elytra run function main:levels/level74/elytra_check