...
scoreboard players add @e[type=marker,name=console,limit=1,tag=lvl60_timer] lvl60_timer 1
execute as @e[type=marker,name=console,limit=1,scores={lvl60_timer=40..}] run function main:levels/level60/close
