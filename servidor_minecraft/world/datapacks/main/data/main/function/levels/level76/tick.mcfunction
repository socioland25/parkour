...
scoreboard players add @e[type=marker,name=console,tag=lvl76_timer] lvl76_timer 1
execute as @e[type=marker,name=console,scores={lvl76_timer=15..}] run function main:levels/level76/close