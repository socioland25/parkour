particle minecraft:dust{color:[0.1,1.0,0.1],scale:2} 14 12 258 0.25 0 0.25 1 1 normal @a
tag @a[x=14.5,y=12,z=258.5,dx=0,dy=0,dz=0] add lvl87effect

effect give @a[tag=lvl87effect,scores={level=87}] minecraft:slow_falling infinite 1 true
effect give @a[tag=lvl87effect,scores={level=87}] minecraft:jump_boost infinite 3 false
