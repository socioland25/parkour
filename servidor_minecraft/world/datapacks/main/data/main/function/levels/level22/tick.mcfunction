...
scoreboard players add @e[type=marker,name=console,tag=lvl22_timer,limit=1] lvl22_timer 1
execute as @e[type=marker,name=console,scores={lvl22_timer=100..},limit=1] run function main:levels/level22/close
